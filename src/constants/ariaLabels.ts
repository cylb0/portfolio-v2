...
export const carouselAriaLabels: Record<
  Language,
...
export const scrollAriaLabels: Record<
  Language,
  { top: string; about: string }
> = {
  [Languages.ENGLISH]: {
    top: 'Scroll to top',
...
export const projectCardAriaLabels: Record<
  Language,
  { github: (name: string) => string; live: (name: string) => string }
> = {
  [Languages.ENGLISH]: {
